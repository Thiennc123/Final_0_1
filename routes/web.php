...
Route::middleware(['auth'])->group(function(){
	...
	Route::post('UpdateImage/{id}/{link}','PhotoController@update');
	Route::post('UpdateAlbum/{id}/{link}','AlbumController@update');
	Route::post('UpdateUser/{id}/{link}','UserController@update');
